...
public class Led extends SubsystemBase {
    ...
    private PWMSparkMax m_ledController = new PWMSparkMax(Constants.LED_CONTROLLER_PORT);
    ...
    public enum Pattern {
        ...
        kShot(0.13), kBlack(0.99), kYellow(0.69), kWhite(0.93), kDarkGray(0.97), kHotPink(0.57), kGold(0.67);
